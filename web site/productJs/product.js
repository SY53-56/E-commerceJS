  ...
  const users =JSON.parse(localStorage.getItem("user"))
    ...
    function renderProductPage(product) {
      ...
      plus.addEventListener("click", () => { quantity++; qtyDisplay.textContent = quantity; });
      sub.addEventListener("click", () => { if (quantity > 1) { quantity--; qtyDisplay.textContent = quantity; } });
...
count += quantity;
    ...
    async function showProduct() {
      ...
      renderSmallCards(allProducts.slice(0, 8)); // show some recommendations
